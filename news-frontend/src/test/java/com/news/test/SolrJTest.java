...
public class SolrJTest {
	//指定solr服务器的地址  
    private final static String SOLR_URL = "http://localhost:8090/solr/";  
    ...
    * @throws Exception 
	...
	public List<NewsDetailDto> querySolr(String queryContent) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(JsonUtils.objectToJson(solr.querySolr("*")));
   }
}
